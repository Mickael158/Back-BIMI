...
public class JWTInterceptor extends OncePerRequestFilter {
    ...
    @Autowired
    private com.example.garage_finance.service.LoginService LoginService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        long targetTime = Instant.parse("2025-03-10T00:00:00Z").toEpochMilli();

        if (StringUtils.hasText(token) && currentTime < targetTime) {
            try {
